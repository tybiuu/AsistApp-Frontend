...
class _IconTextBtn extends StatelessWidget {
  ...
  const _IconTextBtn({required this.icon, required this.label, required this.color, required this.onTap});
...
class _EditForm extends StatelessWidget {
  ...
  Color get _inputBg => isDark ? const Color(0xff242836) : const Color(0xfff9fafb);
  Color get _border => isDark ? const Color(0xff2D3042) : const Color(0xfff3f4f6);
  Color get _label => isDark ? const Color(0xff9ca3af) : const Color(0xff6b7280);
  ...
  InputDecoration _decoration() => InputDecoration(
    ...
    focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: AppColors.chart1)),
  );
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _CicloStepper(c: c, isDark: isDark),
  ...
  Widget _labelRow(String text, IconData icon) => Row(
    children: [
      ...
      Text(text, style: TextStyle(color: _label, fontSize: 12, fontWeight: FontWeight.w600)),
    ],
  );

  Widget _field(String label, IconData icon, TextEditingController ctrl) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
  ...
  Widget _phoneField() => Column(
    ...
    children: [
      ...
      Container(
        ...
        child: Row(
          children: [
            Text('+51', style: TextStyle(color: _muted, fontSize: 14, fontWeight: FontWeight.w600)),
  ...
  Widget _saveBtn() => GestureDetector(
    ...
    child: Container(
      height: 50,
      decoration: BoxDecoration(color: AppColors.chart1, borderRadius: BorderRadius.circular(16)),
    ...
    return Column(
      ...
      children: [
        Row(children: [
          ...
          const SizedBox(width: 5),
          Text('Carrera', style: TextStyle(color: _label, fontSize: 12, fontWeight: FontWeight.w600)),
        ]),
        const SizedBox(height: 6),
        // Trigger
        GestureDetector(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (_, i) {
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      color: isActive
                          ? AppColors.chart1.withValues(alpha: isDark ? 0.15 : 0.08)
                          : Colors.transparent,
                      ...
                      child: Text(
                        ...
                        style: TextStyle(
                          color: isActive
                              ? (isDark ? const Color(0xfffb923c) : AppColors.chart1)
                              : _value,
                          fontSize: 14,
...
class _CicloStepper extends StatelessWidget {
  final ProfileController c;
  final bool isDark;
  const _CicloStepper({required this.c, required this.isDark});
  ...
  Color get _muted => isDark ? const Color(0xff6b7280) : const Color(0xff9ca3af);
  Color get _value => isDark ? Colors.white : const Color(0xff1f2937);
  Color get _btnBg => isDark ? const Color(0xff0f1117) : Colors.white;

  @override
  Widget build(BuildContext context) => Obx(() {
    final n = c.dCiclo.value;
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(children: [
          Icon(Icons.menu_book_outlined, size: 12, color: _label),
          const SizedBox(width: 5),
          Text('Ciclo académico', style: TextStyle(color: _label, fontSize: 12, fontWeight: FontWeight.w600)),
        ]),
        const SizedBox(height: 6),
        Container(
          ...
          child: Row(
            children: [
              _StepBtn(icon: Icons.remove, enabled: n > 5,  isDark: isDark, btnBg: _btnBg, border: _border, value: _value, onTap: c.decrementCiclo),
              Expanded(
                child: Column(
                  children: [
                    Text('$n', style: const TextStyle(color: AppColors.chart1, fontSize: 26, fontWeight: FontWeight.w900)),
                    Text(cicloLabel(n), style: TextStyle(color: _muted, fontSize: 10)),
                  ],
                ),
              ),
              _StepBtn(icon: Icons.add,    enabled: n < 10, isDark: isDark, btnBg: _btnBg, border: _border, value: _value, onTap: c.incrementCiclo),
            ],
          ),
        ),
      ],
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: AnimatedOpacity(
      ...
      child: Container(
        ...
        child: Icon(icon, size: 16, color: value),
      ),
    ),
  );
}
