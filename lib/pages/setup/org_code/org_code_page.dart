              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'XXXX-0000',
                    hintStyle: TextStyle(
                      color: isDark ? AppColors.chart1.withValues(alpha: 0.3) : AppColors.chart1.withValues(alpha: 0.4),
                    ),
                    filled: true,
                    fillColor: isDark ? AppColors.chart1.withValues(alpha: 0.1) : const Color(0xfffff7ed),
                    enabledBorder: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(16),
                      borderSide: BorderSide(
                        color: isDark ? AppColors.chart1.withValues(alpha: 0.6) : AppColors.chart1.withValues(alpha: 0.3),
                        width: 2,
                ...
                Obx(() => PrimaryButton(
                  ...
                  onPressed: controller.code().length >= 8 ? controller.submitCode : null,
                )),
